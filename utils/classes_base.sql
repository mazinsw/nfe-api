...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Destinatario` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Produto` ;
...
ENGINE = InnoDB
COMMENT = 'Produto ou serviço que está sendo vendido ou prestado e será adicionado na nota fiscal[L:prod][K:NFe\\Entity|NFe\\Entity\\]';


-- -----------------------------------------------------
-- Table `NFe.Entity.Pessoa`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Pessoa` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Endereco` ;
...
-- Table `NFe.Core.Nota`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Core.Nota` ;
...
-- Table `NFe.Core.NFCe`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Core.NFCe` ;

CREATE TABLE IF NOT EXISTS `NFe.Core.NFCe` (
  `consulta_url` VARCHAR(200) NOT NULL COMMENT 'Texto com o QR-Code impresso no DANFE NFC-e[L:qrCode]')
ENGINE = InnoDB
...
-- Table `NFe.Core.NFe`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Core.NFe` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Emitente` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Core.SEFAZ` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Pagamento` ;
...
ENGINE = InnoDB
COMMENT = 'Pagamento efetuado no pedido[L:pag][K:NFe\\Entity|NFe\\Entity\\]';


-- -----------------------------------------------------
-- Table `NFe.Core.NFSe`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Core.NFSe` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Municipio` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Pais` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.ICMS.Normal` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.PIS.Aliquota` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.COFINS.Aliquota` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.IPI` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.PIS.Quantidade` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.PIS.Isento` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.PIS.Generico` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.COFINS.Generico` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.COFINS.Isento` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.COFINS.Quantidade` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.ICMS.Integral` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.ICMS.Parcial` ;
...
ENGINE = InnoDB
COMMENT = 'Tributação pelo ICMS\n30 - Isenta ou não tributada e com cobrança do ICMS por substituição tributária[L:IMCS30][K:NFe\\Entity\\Imposto\\ICMS|NFe\\Entity\\Imposto\\ICMS\\][H:Base]';


-- -----------------------------------------------------
-- Table `NFe.Entity.Imposto.ICMS.Cobranca`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.ICMS.Cobranca` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.ICMS.Reducao` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.ICMS.Isento` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.ICMS.Diferido` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.ICMS.Cobrado` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.ICMS.Mista` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.ICMS.Generico` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Peso` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Database.Banco` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Database.Estatico` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Common.Configuracao` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Common.Evento` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Database.IBPT` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Common.Ajuste` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Estado` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.Total` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Transporte` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Transporte.Transportador` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Transporte.Tributo` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Transporte.Veiculo` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Volume` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Lacre` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.IPI.Aliquota` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.IPI.Quantidade` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.IPI.Isento` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.II` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.PIS.ST.Aliquota` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.PIS.ST.Quantidade` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.ICMS.Partilha` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.ICMS.Substituto` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.ICMS.Simples.Generico` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.ICMS.Simples.Cobranca` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.ICMS.Simples.Parcial` ;

CREATE TABLE IF NOT EXISTS `NFe.Entity.Imposto.ICMS.Simples.Parcial` (
)
ENGINE = InnoDB
COMMENT = 'Tributada pelo Simples Nacional sem permissão de crédito e com cobrança do ICMS por substituição tributária[L:IMCSSN202][K:NFe\\Entity\\Imposto\\ICMS\\Simples|NFe\\Entity\\Imposto\\ICMS\\Simples\\][H:\\NFe\\Entity\\Imposto\\ICMS\\Parcial]';


-- -----------------------------------------------------
-- Table `NFe.Entity.Imposto.ICMS.Simples.Cobrado`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.ICMS.Simples.Cobrado` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.ICMS.Simples.Normal` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.ICMS.Simples.Isento` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.COFINS.ST.Aliquota` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.COFINS.ST.Quantidade` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Task.Autorizacao` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Task.Protocolo` ;
...
CREATE TABLE IF NOT EXISTS `NFe.Task.Protocolo` (
  ...
  `validacao` VARCHAR(45) NOT NULL COMMENT 'Digest Value da NF-e processada. Utilizado para conferir a integridade da NF-e original.[L:digVal]',
  `numero` VARCHAR(45) NOT NULL COMMENT 'Número do Protocolo de Status da NF-e. 1 posição (1 – Secretaria de Fazenda Estadual 2 – Receita Federal); 2 - códiga da UF - 2 posições ano; 10 seqüencial no ano.[L:nProt]')
ENGINE = InnoDB
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Task.Inutilizacao` ;
...
CREATE TABLE IF NOT EXISTS `NFe.Task.Inutilizacao` (
  ...
  `ano` VARCHAR(45) NOT NULL COMMENT 'Ano de inutilização da numeração[L:ano]',
  `cnpj` VARCHAR(45) NOT NULL COMMENT 'CNPJ do emitente[L:CNPJ]',
  `modelo` VARCHAR(45) NOT NULL COMMENT 'Modelo da NF-e (55, 65 etc.)[L:mod]',
  `serie` VARCHAR(45) NOT NULL COMMENT 'Série da NF-e[L:serie]',
  `inicio` INT NOT NULL COMMENT 'Número da NF-e inicial[L:nNFIni]',
  `final` INT NOT NULL COMMENT 'Número da NF-e final[L:nNFFin]',
  `justificativa` VARCHAR(45) NOT NULL COMMENT 'Justificativa do pedido de inutilização[L:xJust]',
  `numero` VARCHAR(45) NOT NULL COMMENT 'Número do Protocolo de Status da NF-e. 1 posição (1 – Secretaria de Fazenda Estadual 2 – Receita Federal); 2 - código da UF - 2 posições ano; 10 seqüencial no ano.[L:nProt]')
ENGINE = InnoDB
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Task.Evento` ;
...
CREATE TABLE IF NOT EXISTS `NFe.Task.Evento` (
  ...
  `identificador` VARCHAR(45) NOT NULL COMMENT 'Identificação do  autor do evento[L:CNPJ|CPF]',
  `chave` VARCHAR(45) NOT NULL COMMENT 'Chave de Acesso da NF-e vinculada ao evento[L:chNFe]',
  ...
  `tipo` VARCHAR(45) NOT NULL DEFAULT '110111' COMMENT 'Tipo do Evento[L:tpEvento][F:self::TIPO_CANCELAMENTO]',
  `sequencia` VARCHAR(45) NOT NULL DEFAULT '1' COMMENT 'Seqüencial do evento para o mesmo tipo de evento.  Para maioria dos eventos será 1, nos casos em que possa existir mais de um evento, como é o caso da carta de correção, o autor do evento deve numerar de forma seqüencial.[L:nSeqEvento][F:1]',
  `descricao` VARCHAR(45) NOT NULL DEFAULT 'Cancelamento' COMMENT 'Descrição do Evento[L:descEvento][F:\'Cancelamento\']',
  `numero` VARCHAR(45) NOT NULL COMMENT 'Número do Protocolo de Status da NF-e. 1 posição (1 – Secretaria de Fazenda Estadual 2 – Receita Federal); 2 posições ano; 10 seqüencial no ano.[L:nProt]',
  `justificativa` VARCHAR(45) NOT NULL COMMENT 'Justificativa do cancelamento[L:xJust]',
  `email` VARCHAR(45) NOT NULL COMMENT 'email do destinatário[L:emailDest]',
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Task.Status` ;
...
ENGINE = InnoDB
COMMENT = 'Status das respostas de envios para os servidores da SEFAZ[K:NFe\\Task|NFe\\Task\\]';


-- -----------------------------------------------------
-- Table `NFe.Task.Envio`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Task.Envio` ;
...
CREATE TABLE IF NOT EXISTS `NFe.Task.Envio` (
  ...
  `ambiente` VARCHAR(45) NOT NULL COMMENT 'Identificação do Ambiente:\n1 - Produção\n2 - Homologação[S]',
  `modelo` VARCHAR(45) NOT NULL COMMENT 'Código do modelo do Documento Fiscal. 55 = NF-e; 65 = NFC-e.[S]',
  `emissao` VARCHAR(45) NOT NULL COMMENT 'Forma de emissão da NF-e[S]',
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Task.Retorno` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Task.Recibo` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Task.Situacao` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Task.Tarefa` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Entity.Imposto.ICMS.Base` ;
...
-- -----------------------------------------------------
-- Table `NFe.Log.Logger`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NFe.Log.Logger` ;

CREATE TABLE IF NOT EXISTS `NFe.Log.Logger` (
...
ENGINE = InnoDB
COMMENT = 'Salva mensagens de erro, depuração entre outros[K:NFe\\Log|NFe\\Log\\]';
