...
CREATE TABLE IF NOT EXISTS `Produto` (
  ...
  `peso` VARCHAR(45) NOT NULL DEFAULT 'new Peso()' COMMENT '[F:new Peso()][S]',
...
CREATE TABLE IF NOT EXISTS `NF` (
  ...
  `cliente` VARCHAR(45) NULL DEFAULT 'new Cliente()' COMMENT '[F:new Cliente()][S][L:dest]',
  `produtos` VARCHAR(45) NOT NULL DEFAULT 'array()' COMMENT '[F:array()][S:S][U:produtos|produto][L:prod]',
  `transporte` VARCHAR(45) NULL DEFAULT 'new Transporte()' COMMENT '[F:new Transporte()][S][L:transp]',
  `pagamentos` VARCHAR(45) NULL DEFAULT 'array()' COMMENT '[F:array()][S:S][U:pagamentos|pagamento][L:pag]',
...
CREATE TABLE IF NOT EXISTS `SEFAZ` (
  `notas` INT NOT NULL DEFAULT 'array()' COMMENT '[D][F:array()][S:S][L:NFe][N:Notas|Nota]',
...
ENGINE = InnoDB
COMMENT = 'Classe base do ICMS normal[L:ICMS][K:Imposto\\ICMS|Imposto\\ICMS\\][H:Base]';
...
ENGINE = InnoDB
COMMENT = 'Tributação pelo ICMS\n30 - Isenta ou não tributada e com cobrança do ICMS por substituição tributária[L:IMCS30][K:Imposto\\ICMS|Imposto\\ICMS\\][H:Base]';
...
CREATE TABLE IF NOT EXISTS `Configuracao` (
  `banco` VARCHAR(45) NOT NULL DEFAULT 'new \\BD\\Estatico()' COMMENT 'Banco que fornece informações sobre items da nota como: Códigos e Taxas[S][F:new \\BD\\Estatico()]',
...
CREATE TABLE IF NOT EXISTS `Transporte` (
  ...
  `retencao` VARCHAR(45) NULL DEFAULT 'new \\Transporte\\Tributo()' COMMENT 'Dados da retenção  ICMS do Transporte[L:retTransp][F:new \\Transporte\\Tributo()][S]',
...
ENGINE = InnoDB
COMMENT = '[K:NF|NF\\][H:Retorno][L:infEvento]';
...
-- Table `NF.Recibo`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NF.Recibo` ;

CREATE TABLE IF NOT EXISTS `NF.Recibo` (
  ...
  `modelo` VARCHAR(45) NOT NULL COMMENT '[L:mod]')
ENGINE = InnoDB
COMMENT = '[K:NF|NF\\][H:Retorno][L:retConsReciNFe]';


-- -----------------------------------------------------
-- Table `NF.Situacao`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NF.Situacao` ;

CREATE TABLE IF NOT EXISTS `NF.Situacao` (
  `chave` VARCHAR(45) NOT NULL COMMENT 'Chaves de acesso da NF-e, compostas por: UF do emitente, AAMM da emissão da NFe, CNPJ do emitente, modelo, série e número da NF-e e código numérico+DV.[L:chNFe]',
  `modelo` VARCHAR(45) NOT NULL COMMENT '[L:mod]')
ENGINE = InnoDB
COMMENT = '[K:NF|NF\\][H:Retorno][L:retConsSitNFe]';


-- -----------------------------------------------------
-- Table `NF.Tarefa`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NF.Tarefa` ;

CREATE TABLE IF NOT EXISTS `NF.Tarefa` (
  ...
  `agente` VARCHAR(45) NULL COMMENT 'Agente que obteve ou vai obter a resposta, podendo ser: pedido de inutilização(NF\\Inutilizacao), recibo(NF\\Recibo) ou pedido de cancelamento(NF\\Evento)[S]',
...
-- -----------------------------------------------------
-- Table `Imposto.ICMS.Base`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Imposto.ICMS.Base` ;

CREATE TABLE IF NOT EXISTS `Imposto.ICMS.Base` (
...
ENGINE = InnoDB
COMMENT = 'Classe base do ICMS, estende de Imposto[L:ICMS][K:Imposto\\ICMS|Imposto\\ICMS\\][H:Imposto]';
