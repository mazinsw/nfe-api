...
CREATE TABLE IF NOT EXISTS `Configuracao` (
  ...
  `tempo_limite` VARCHAR(45) NOT NULL COMMENT 'Tempo limite em segundos nas conexões com os Web services, 0 para sem tempo limite[S]',
  `sincrono` ENUM('Y', 'N') NOT NULL DEFAULT 'Y' COMMENT 'Informa se o processo de autorização da nota é síncrono ou assíncrono[S]')
ENGINE = InnoDB;
