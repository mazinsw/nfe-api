...
CREATE TABLE IF NOT EXISTS `NF` (
  ...
  `protocolo` VARCHAR(45) NULL COMMENT '[S]')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `NF.Autorizacao` (
  ...
  `data_recebimento` DATETIME NOT NULL COMMENT '[L:dhRecbto]')
ENGINE = InnoDB
COMMENT = '[K:NF|NF\\]';
...
CREATE TABLE IF NOT EXISTS `NF.Protocolo` (
  ...
  `numero` VARCHAR(45) NOT NULL COMMENT '[nProt]')
ENGINE = InnoDB
COMMENT = '[K:NF|NF\\][H:Autorizacao]';
...
CREATE TABLE IF NOT EXISTS `NF.Inutilizacao` (
  ...
  `ambiente` VARCHAR(45) NOT NULL COMMENT '[L:tpAmb][S]',
  `uf` VARCHAR(45) NOT NULL COMMENT '[L:cUF][S]',
  `ano` VARCHAR(45) NOT NULL COMMENT '[L:ano][S]',
  `cnpj` VARCHAR(45) NOT NULL COMMENT '[L:CNPJ][S]',
  `modelo` VARCHAR(45) NOT NULL COMMENT '[L:mod][S]',
  `serie` VARCHAR(45) NOT NULL COMMENT '[L:serie][S]',
  `inicio` INT NOT NULL COMMENT '[L:nNFIni][S]',
  `final` INT NOT NULL COMMENT '[L:nNFFin][S]',
  `justificativa` VARCHAR(45) NOT NULL COMMENT '[L:xJust][S]')
ENGINE = InnoDB
COMMENT = '[K:NF|NF\\][L:inutNFe]';
...
CREATE TABLE IF NOT EXISTS `NF.Evento` (
  `ambiente` VARCHAR(45) NOT NULL COMMENT '[S][L:tpAmb]',
  `versao` VARCHAR(45) NOT NULL COMMENT '[S][L:verAplic]',
  `status` VARCHAR(45) NOT NULL COMMENT '[S][L:cStat]',
  `motivo` VARCHAR(45) NOT NULL COMMENT '[S][L:xMotivo]',
  `uf` VARCHAR(45) NOT NULL COMMENT '[L:cUF][S]',
  `data_recebimento` DATETIME NOT NULL COMMENT '[S][L:dhRecbto]')
ENGINE = InnoDB
COMMENT = '[K:NF|NF\\]';
